...
require (
	...
	github.com/cko-recruitment/payment-gateway-challenge-go/bank v0.0.0
	github.com/cko-recruitment/payment-gateway-challenge-go/common v0.0.0
	github.com/cko-recruitment/payment-gateway-challenge-go/payment v0.0.0
...
replace (
	...
	github.com/cko-recruitment/payment-gateway-challenge-go/payment => ./payment
